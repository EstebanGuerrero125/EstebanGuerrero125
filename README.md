...
- **Detección de defectos en acero (deep learning)** — Proyecto personal en desarrollo para clasificar defectos superficiales en imágenes de acero, aplicado a mi perfil de IA/ML.
- **Catálogo de productos para tienda de ropa deportiva** — Sitio construido con React, Vite, Tailwind CSS y React Router para un negocio propio de camisetas y ropa deportiva.
